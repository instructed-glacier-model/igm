...
class NoInflow(BoundaryCondition):
    ...
    def apply(self, U: TV, V: TV) -> Tuple[TV, TV]:
        ...
        factor = 1.1 # increase outflow by 10% to avoid numerical issues with zero velocities at the boundary
